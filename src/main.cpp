...
int main(int argc, char *argv[])
{
	...
	skinlist.init();
	announcerlist.init(convertPath("sfx/announcer/"), ".txt");
	musiclist.init();
	worldmusiclist.init();
	menugraphicspacklist.init(convertPath("gfx/packs/"));
	worldgraphicspacklist.init(convertPath("gfx/packs/"));
